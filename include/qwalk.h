...
extern /*@null@*/QwalkLayer_t      *qwalk_area_layer_earth_get(QwalkArea_t *)/*@*/;

/** Get the layer_floater member from a #QwalkArea_t */
extern /*@null@*/QwalkLayer_t      *qwalk_area_layer_floater_get(QwalkArea_t *)/*@*/;


/** Get a specific #QwalkObj_t * from a #QwalkLayer_t */
extern /*@null@*/QwalkObj_t    *qwalk_layer_object_get(QwalkLayer_t *, int)/*@*/;
